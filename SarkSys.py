...
try:
    os.chdir("C:/Users/<your_name>/SarkSys")
    first_try = False
except:
    os.mkdir("C:/Users/<your_name>/SarkSys")
    os.chdir("C:/Users/<your_name>/SarkSys")
    first_try = True
...
root = 'C:/Users/<your_name>/SarkSys/0-ss'
home = ''
...
def fixUser():
    with open('C:/Users/<your_name>/SarkSys/0-ss/4-boot/5-login', 'r') as f:
...
def getHostname():
    if not os.path.isdir('C:/Users/<your_name>/SarkSys/0-ss/5-etc'):
        os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/5-etc')
        cur.execute("INSERT INTO inode VALUES(5, 'etc', 'core', 'core', '755')")
    if not os.path.isdir('C:/Users/<your_name>/SarkSys/0-ss/5-etc/9-host'):
        os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/5-etc/9-host')
        cur.execute("INSERT INTO inode VALUES(9, 'host', 'core', 'core', '777')")
    if not os.path.isfile('C:/Users/<your_name>/SarkSys/0-ss/5-etc/9-host/7-hostname'):
        with open('C:/Users/<your_name>/SarkSys/0-ss/5-etc/7-hostname', 'w') as f:
            f.write("SarkSys")
        cur.execute("INSERT INTO inode VALUES(7, 'hostname', 'core', 'core', '766')")
    with open('C:/Users/<your_name>/SarkSys/0-ss/5-etc/9-host/7-hostname', 'r') as f:
        g = f.read()
    conn.commit()
    return g.strip('\n')
    ...
    if user == 'core':
        if len(c) == 1:
            ...
            if userExists(c[1]):
                ...
                llogin(c[1])
                login(c[1])
                for i in os.listdir('C:/Users/<your_name>/SarkSys/0-ss/2-home'):
                    if i.endswith(c[1]):
                        ind = i.split('-')[0]
                os.chdir('C:/Users/<your_name>/SarkSys/0-ss/2-home/{}-{}'.format(ind, c[1]))
                home = 'C:/Users/<your_name>/SarkSys/0-ss/2-home/{}-{}'.format(ind, c[1])
                variables = {}
                alias = {}
                g_alias = {}
                return c[1]
        ...
        if len(c) == 1:
            ...
            if cur.fetchall():
                ...
                llogin('core')
                login('core')
                os.chdir('C:/Users/<your_name>/SarkSys/0-ss/1-core')
                home = 'C:/Users/<your_name>/SarkSys/0-ss/1-core'
                variables = {}
                alias = {}
                g_alias = {}
                return 'core'
...
def useradd(usr):
    ...
    if user == 'core' or cudo_:
        ...
        if cur.fetchone():
            ...
            os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/2-home/{}-{}'.format(str(ind), usr))
        cudo_ = False
    else:
    ...
    if user == 'core' or cudo_:
        ...
        if cur.fetchone():
            ...
            for i in os.listdir('C:/Users/<your_name>/SarkSys/0-ss/2-home'):
                if i.endswith(usr):
                    ind = i.split('-')[0]
            shutil.rmtree('C:/Users/<your_name>/SarkSys/0-ss/2-home/{}-{}'.format(ind, usr), ignore_errors = True)
...
def ls(c):
    if len(c) == 1:
        ...
        if c[1].startswith('/'):
            r = 'C:/Users/<your_name>/SarkSys/0-ss'
            go = True
    ...
    if len(c) == 1:
        ...
        if c[1].startswith('..'):
            if '/' in c[1]:
                for i in c[1].split('/'):
                    if i == '..':
                        if os.getcwd() == 'C:\\Users\\<your_name>\\SarkSys\\0-ss':
                            return
                        os.chdir('..')
                    else:
                        for j in os.listdir():
            ...
            if c[1] == '/':
                os.chdir('C:/Users/<your_name>/SarkSys/0-ss')
            else:
                os.chdir('C:/Users/<your_name>/SarkSys/0-ss')
                for i in c[1].split('/')[1:]:
                    found = False
...
def inlog(c):
    global cudo_
    if '-d' in c:
            if not os.path.isdir('C:/Users/<your_name>/SarkSys/0-ss/4-boot'):
                os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/4-boot')
                cur.execute("INSERT INTO inode VALUES(4, 'boot', 'core', 'core', '755')")
            with open('C:/Users/<your_name>/SarkSys/0-ss/4-boot/5-login', 'w') as f:
                pass
    else:
        if user == 'core' or cudo_:
            if not os.path.isdir('C:/Users/<your_name>/SarkSys/0-ss/4-boot'):
    ...
    if c[2].startswith('/'):
        if c[2] == '/':
            ...
            if not perm:
                print("E: / : Permission denied")
                return
            shutil.copyfile(c[1], 'C:/Users/<your_name>/SarkSys/0-ss')
        else:
            perm = False
            od = 'C:/Users/<your_name>/SarkSys/0-ss'
            for i in c[2].split('/'):
                found = False
...
if first_try:
    os.mkdir('C:/Users/<your_name>/SarkSys/0-ss')
    os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/2-home')
    ...
    os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/1-core')
    cur.execute("INSERT INTO usr VALUES ('{}', '{}')".format(un, enc(pw)))
    os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/2-home/3-{}'.format(un))
    os.chdir('C:/Users/<your_name>/SarkSys/0-ss/2-home/3-{}'.format(un))
    cur.execute("INSERT INTO cudoers VALUES ('{}')".format(un))
    home = 'C:/Users/<your_name>/SarkSys/0-ss/2-home/3-{}'.format(un)
    ...
    with open('C:/Users/<your_name>/SarkSys/0-ss/4-boot/5-login', 'w') as f:
        pass
    cur.execute("INSERT INTO inode VALUES(7, 'hostname', 'core', 'core', '766')")
    with open('C:/Users/<your_name>/SarkSys/0-ss/5-etc/9-host/7-hostname', 'w') as f:
        f.write('SarkSys')
    login(un)
    conn.commit()
    access = True
    ...
    while True:
        ...
        if cur.fetchall():
            ...
            if un == 'core':
                ...
                for i in os.listdir('C:/Users/<your_name>/SarkSys/0-ss/2-home/'):
                    if os.path.isdir('C:/Users/<your_name>/SarkSys/0-ss/2-home/' + i) and i.endswith(un):
                        os.chdir('C:/Users/<your_name>/SarkSys/0-ss/2-home/{}'.format(i))
                        home = 'C:/Users/<your_name>/SarkSys/0-ss/2-home/{}'.format(i)
            if up:
                if not os.path.isdir('C:/Users/<your_name>/SarkSys/0-ss/4-boot'):
                    os.mkdir('C:/Users/<your_name>/SarkSys/0-ss/4-boot')
                    cur.execute("INSERT INTO inode VALUES(4, 'boot', 'core', 'core', '755')")
